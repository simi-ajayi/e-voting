...
const TicketTransferEmail = () => {
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#ffffff', margin: 0, padding: 0, textAlign: 'center' }}>
      ...
      <div style={{ backgroundColor: '#0046bf', padding: '20px', color: '#ffffff', fontSize: '20px', fontWeight: 'bold', textAlign: 'center' }}>
  ...
  <div style={{ display: 'flex', justifyContent: 'space-between', width: '60%', position: 'relative' }}>
    {/* Progress line */}
    <div style={{ position: 'absolute', top: '30%', left: '0', right: '0', height: '2px', width:'200px', backgroundColor: '#cccccc', zIndex: 0 }}></div>

    {/* Step 1: Received */}
    <div style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
      <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#0046bf', display: 'flex', justifyContent: 'center', alignItems: 'center', border: '2px dashed transparent' }}>
    ...
    {/* Step 2: Accepted */}
    <div style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
      <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#ffffff', display: 'flex', justifyContent: 'center', alignItems: 'center', border: '2px dashed #cccccc' }}>
